...
1. ##### 결제 홈 구성
	1. 결재 상태별 최신 문서 목록이나 수 / 발신함의 수신 대기 문서, 반송된 문서 등 사용자가 확인해야 할 문서 정보를 한눈에 확인할 수 있습니다.
		1. ![Pasted image 20231019190014.png](/img/user/Attach/Pasted%20image%2020231019190014.png)
			1. 결재 상태별 문서 목록
			...
			2. 수 / 발신 문서 목록
				...
				2. 반송 : 발신함의 수신 반송 상태의 최신 문서 목록 표시
...
1. ##### 결재문서 작성절차
	...
	3. 다음 단계를 차례대로 진행해 주십시오.
		1. [결재 문서 서식 선택](https://guide.ncloud-docs.com/docs/workplace-workplace-2-2#1결재문서서식선택)
			1. ![Pasted image 20231020075659.png](/img/user/Attach/Pasted%20image%2020231020075659.png)
		2. [내용 작성](https://guide.ncloud-docs.com/docs/workplace-workplace-2-2#2내용작성)
			1. ![Pasted image 20231019202552.png](/img/user/Attach/Pasted%20image%2020231019202552.png)
...
1. ##### 문서함
	1. **결재 홈** 화면의 좌측 메뉴 영역에서 조회하려는 문서함을 클릭해 주십시오.
	2. ![Pasted image 20231019210959.png](/img/user/Attach/Pasted%20image%2020231019210959.png)
2. ##### 문서함 종류
	1. 결재 문서
	...
	8. ==결재 문서 리포트 조회== : 결재 문서 리포트 중 내가 조회 권한을 부여 받은 문서 목록 표시
		1. 결재 문서 리포트 조회 메뉴에서는 조회 권한이 있는 결재 문서 리포트 데이터를 조회하고 결과를 분석하여 집계에 사용할 수 있습니다.
		2. ![Pasted image 20231019203222.png](/img/user/Attach/Pasted%20image%2020231019203222.png)
...
{ #fb9e1a}
	...
	5. 업무처리 절차
		...
		3. 처리 문서 작성
			...
			2. 처리 문서는 일반 기안지(수신) 서식으로 작성합니다.
	6. ![Pasted image 20231019203922.png](/img/user/Attach/Pasted%20image%2020231019203922.png)
3. ##### 발신함
{ #00bfcb}
	...
	3. 발신 회수
		...
		2. 발신 회수 시 전체 발신자의 발신함에서 삭제됩니다.
	4. ![Pasted image 20231019205307.png](/img/user/Attach/Pasted%20image%2020231019205307.png)

### 7. 결재선
1. ##### 나의 결재선
	1. 나의 결재선 메뉴에서는 자주 사용하는 결재선, 수신 그룹, 공유 그룹을 등록 후 결재 문서 작성 시 간편하게 불러와 사용할 수 있습니다.
	2. ![Pasted image 20231019210009.png](/img/user/Attach/Pasted%20image%2020231019210009.png)
2. ##### 회사 결재선
